 ...
 * NOTE: healthScore đã move sang useCFOSnapshot (deterministic 5-component formula
 * trong cfoHealthScore.ts). Hook này giờ chỉ phục vụ chart data thuần
 * (StackedBarChart + SavingsLineChart).
 */
'use client';
...
export function useChartData() {
  ...
  // Monthly savings growth (last 6 months) — demo data
  ...
  return { weeklyComparison, savingsGrowth };
}
